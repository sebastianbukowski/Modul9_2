...
(function(){
	...
	*/
	...
	var showModal = function(event){
		...
		console.log('event clicked link => ', event);
		var clickedLink = event.target;
		var clickedLinkHref = clickedLink.getAttribute('href');
		var modalToShow = document.querySelector(clickedLinkHref);
		removeShowClass();
		console.log('modal to show ',modalToShow);
		console.log('clickedLinkHref => ', clickedLinkHref);
		modalToShow.querySelector('.modal header').innerHTML = 'Clicked modal';
